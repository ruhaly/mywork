...
document.write('<input type="hidden" name="artID" value="404920" />');
document.write('<input type="hidden" name="referer" value="http://mobile.51cto.com/aengine-404920.htm" />');
...
document.write('</td><td width="13%"><input type="submit" style="background: url(&quot;http://www.51cto.com/php/tijiao.gif&quot;) no-repeat scroll 0% 0% transparent;cursor: pointer; height: 30px; width: 80px;" name="Submit32" value=""/>');
